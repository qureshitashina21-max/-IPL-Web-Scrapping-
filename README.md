...
IPL_Winner_Analysis.ipynb — Full notebook with scraping + cleaning + analysis
ipl_winners.csv — Clean dataset extracted from Wikipedia
README.md — Project documentation
📊 Insights
Identified every IPL winner from 2008 onwards
Analyzed team performance trends
Visualized frequency of wins
